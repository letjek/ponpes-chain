...
// Frontier
use ponpes_chain_runtime::{AccountId, Balance, SS58Prefix, Signature, WASM_BINARY};
...
pub fn production_config() -> ChainSpec {
	let sudo_account = AccountId::from(hex!("1b1c5b8396aaea5b4f1a50c0c7824f4f71f3c36d"));

	ChainSpec::builder(WASM_BINARY.expect("WASM not available"), Default::default())
		.with_name("Ponpes Chain")
		.with_id("ponpes_chain")
		...
		.with_genesis_config_patch(testnet_genesis(
			...
			vec![
				sudo_account,
				AccountId::from(hex!("4c7d4515757e7662132ad39abc1a0bb2f5e2c4ca")),
				AccountId::from(hex!("9b5a6f19a413f30e7cb35c50a6481d948e57843d")),
			],
			vec![
				authority_keys_from_seed("AuthorityOne"),
				authority_keys_from_seed("AuthorityTwo"),
			],
			2_000_625,
			false,
		))
